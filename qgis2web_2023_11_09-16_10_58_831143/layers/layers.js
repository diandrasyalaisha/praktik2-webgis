...
var format_ServiceAreaND_6_Roads_NA_SAI_4 = new ol.format.GeoJSON();
var features_ServiceAreaND_6_Roads_NA_SAI_4 = format_ServiceAreaND_6_Roads_NA_SAI_4.readFeatures(json_ServiceAreaND_6_Roads_NA_SAI_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ServiceAreaND_6_Roads_NA_SAI_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ServiceAreaND_6_Roads_NA_SAI_4.addFeatures(features_ServiceAreaND_6_Roads_NA_SAI_4);
var lyr_ServiceAreaND_6_Roads_NA_SAI_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_ServiceAreaND_6_Roads_NA_SAI_4, 
                style: style_ServiceAreaND_6_Roads_NA_SAI_4,
                interactive: true,
                title: '<img src="styles/legend/ServiceAreaND_6_Roads_NA_SAI_4.png" /> Service Area — ND_6_Roads_NA_SAI'
            });
var format_ServiceAreaRoads_NA_5 = new ol.format.GeoJSON();
var features_ServiceAreaRoads_NA_5 = format_ServiceAreaRoads_NA_5.readFeatures(json_ServiceAreaRoads_NA_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ServiceAreaRoads_NA_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ServiceAreaRoads_NA_5.addFeatures(features_ServiceAreaRoads_NA_5);
var lyr_ServiceAreaRoads_NA_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_ServiceAreaRoads_NA_5, 
                style: style_ServiceAreaRoads_NA_5,
                interactive: true,
                title: '<img src="styles/legend/ServiceAreaRoads_NA_5.png" /> Service Area — Roads_NA'
            });
...
lyr_Buildings_0.setVisible(true);lyr_Roads_1.setVisible(true);lyr_Bus_Stops_2.setVisible(true);lyr_ServiceAreaND_6_DirtyAreas_3.setVisible(true);lyr_ServiceAreaND_6_Roads_NA_SAI_4.setVisible(true);lyr_ServiceAreaRoads_NA_5.setVisible(true);lyr_ServiceAreaKeputih_Dataset_ND_Junctions_6.setVisible(true);
var layersList = [lyr_Buildings_0,lyr_Roads_1,lyr_Bus_Stops_2,lyr_ServiceAreaND_6_DirtyAreas_3,lyr_ServiceAreaND_6_Roads_NA_SAI_4,lyr_ServiceAreaRoads_NA_5,lyr_ServiceAreaKeputih_Dataset_ND_Junctions_6];
...
lyr_ServiceAreaND_6_Roads_NA_SAI_4.set('fieldAliases', {'OID': 'OID', 'SourceOID': 'SourceOID', 'TS1': 'TS1', 'TS2': 'TS2', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', });
lyr_ServiceAreaRoads_NA_5.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'osm_id': 'osm_id', 'name': 'name', 'highway': 'highway', 'waterway': 'waterway', 'aerialway': 'aerialway', 'barrier': 'barrier', 'man_made': 'man_made', 'railway': 'railway', 'z_order': 'z_order', 'other_tags': 'other_tags', 'Shape_Length': 'Shape_Length', });
...
lyr_Bus_Stops_2.set('fieldImages', {'osm_id': '', 'name': '', 'barrier': '', 'highway': '', 'ref': '', 'address': '', 'is_in': '', 'place': '', 'man_made': '', 'other_tags': '', });
lyr_ServiceAreaND_6_DirtyAreas_3.set('fieldImages', {'ObjectID': '', 'IsRetired': '', 'DirtyArea_Length': '', 'DirtyArea_Area': '', });
lyr_ServiceAreaND_6_Roads_NA_SAI_4.set('fieldImages', {'OID': '', 'SourceOID': '', 'TS1': '', 'TS2': '', 'Shape_Length': '', 'Shape_Area': '', });
lyr_ServiceAreaRoads_NA_5.set('fieldImages', {'OBJECTID': '', 'osm_id': '', 'name': '', 'highway': '', 'waterway': '', 'aerialway': '', 'barrier': '', 'man_made': '', 'railway': '', 'z_order': '', 'other_tags': '', 'Shape_Length': '', });
lyr_ServiceAreaKeputih_Dataset_ND_Junctions_6.set('fieldImages', {'OBJECTID': '', });
...
lyr_ServiceAreaND_6_Roads_NA_SAI_4.set('fieldLabels', {'OID': 'no label', 'SourceOID': 'no label', 'TS1': 'no label', 'TS2': 'no label', 'Shape_Length': 'no label', 'Shape_Area': 'no label', });
lyr_ServiceAreaRoads_NA_5.set('fieldLabels', {'OBJECTID': 'no label', 'osm_id': 'no label', 'name': 'no label', 'highway': 'no label', 'waterway': 'no label', 'aerialway': 'no label', 'barrier': 'no label', 'man_made': 'no label', 'railway': 'no label', 'z_order': 'no label', 'other_tags': 'no label', 'Shape_Length': 'no label', });
